...
from Binance.utils import setup_logger, get_project_root
...
class TestDownloadAndMerge(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_data_dir = cls.project_root / "test_data_download_merge"
        cls.symbol = "BCHUSDT"
        ...
        # Paths
        cls.price_root_dir = str(cls.test_data_dir.relative_to(cls.project_root))
    ...
    def test_02_merge_compact(self):
        ...
        price_dd = helper.load_base_price(
            ...
            symbol=self.symbol,
            price_data_path=str(self.test_data_dir),
    ...
    def test_03_incremental_download(self):
        ...
        # Initial download
        result1 = BinanceMarketDataDownloader.catchup_price_binance(
            symbol=self.symbol,
            kline_tframe=self.tframe,
            default_download_start_date=self.start_date,
            price_root_dir=self.price_root_dir,
        ...
        # Run incremental download (should detect and fill gap)
        result2 = BinanceMarketDataDownloader.catchup_price_binance(
            symbol=self.symbol,
            kline_tframe=self.tframe,
            default_download_start_date=self.start_date,
            price_root_dir=self.price_root_dir,
